public class Beisbol extends DeConjunto {
    Beisbol(){

    }
    
   Beisbol (String disciplina, String rama, String categoria, String sede, String etapa, String fecha, String hora, String ganador,
