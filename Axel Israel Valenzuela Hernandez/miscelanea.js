...
//     var totalCompra = 0;
//     var mensaje = "Gracias, ¡vuelva pronto!";

//     do {
//         var producto = prompt("Ingrese el nombre del producto:");
//         var precio = parseFloat(prompt("Ingrese el precio de " + producto + ":"));

//         if (!isNaN(precio)) {
//             totalCompra += precio;
//         } else {
//             alert("Por favor, ingrese un precio válido para " + producto);
//         }

//         var respuesta = confirm("¿Desea agregar otro producto?");
//     } while (respuesta);
...
//calculadora de la tiemda que vimos en clase
